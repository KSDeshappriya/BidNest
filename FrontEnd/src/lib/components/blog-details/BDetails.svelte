            ...
            <div class="col-lg-8">
                <div class="blog-details-single">
                    ...
                    <div class="blog-content">
                        <p class="para">Gochujang ugh viral, butcher pabst put a bird on it meditation austin craft
                            beer banh. Distillery ramps af, goch ujang hell of VHS kitsch austin. Vegan air plant
                    ...
                    <div class="blog-author gap-4 flex-md-nowrap flex-wrap">
                        ...
                        <div class="author-detials text-md-start text-center">
                            <h5>-- Leslie Alexander</h5>
                            <p class="para">It has survived not only five centuries, but also the leap into
                                electronic typesetting unchanged. It was popularised in the sheets containing lorem
