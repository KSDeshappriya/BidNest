                ...
                <div class="col-lg-3 col-md-6 d-flex justify-content-lg-center">
                    <div class="footer-item">
                        ...
                        <ul class="footer-list">
                            <li><a href="live-auction/">All Product</a></li>
                            <li><a href="how-works/">How It Works</a></li>
                            <li><a href="dashboard/">My Account</a></li>
                            <li><a href="about/">About Company</a></li>
                            <li><a href="blog/">Our News Feed</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 d-flex justify-content-lg-center">
                    <div class="footer-item">
                        <h5>Help & FAQs</h5>
                        <ul class="footer-list">
                            <li><a href="product/">Help Center</a></li>
                            <li><a href="faq/">Customer FAQs</a></li>
                            <li><a href="login/">Terms and Conditions</a></li>
                            <li><a href="about/">Security Information</a></li>
                            <li><a href="blog/">Merchant Add Policy</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <div class="footer-item">
                        ...
                        <ul class="recent-feed-list">
                            {#each recentFeeds as feed}
                                <li class="single-feed">
                                    <div class="feed-img">
                                        <a href={feed.link}>
                                            <img alt="recent feed image" src={feed.imgSrc}>
                                        </a>
                                    </div>
        ...
        <div class="container">
            <div class="row d-flex align-items-center g-4">
                <div class="col-lg-6 d-flex justify-content-lg-start justify-content-center">
                    <p>Copyright 2022 <a href="#">Bid Out</a> | Design By <a href="/" class="egns-lab">Group 05</a></p>
                </div>
